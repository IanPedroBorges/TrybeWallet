...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-032-b-project-trybewallet-ts.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-032-b-project-trybewallet-ts`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-032-b-project-trybewallet-ts`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-032-b-project-trybewallet-ts`

  6. Crie um novo Pull Request (PR)

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-032-b-project-trybewallet-ts/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-032-b-project-trybewallet-ts/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH32-B&template=betrybe/sd-032-b-project-trybewallet-ts-ts)
